...
if cust_id:
    ...
    docs = collection.find(query , { "_id": 0, "StockCode": 0, "Description": 0, "Quantity": 0, "Country": 0, "UnitPrice": 0})
...
if inv_no:
    ...
    docs = collection.find(query, { "_id": 0, "InvoiceDate": 0, "Country": 0, "CustomerID": 0 })
